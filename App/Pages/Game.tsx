          ...
          <>
            ...
            <View style={styles.buttonwrapper}>
              <View style={styles.wrap1}>
                <ActionButton onPress={() => play("smash")} text="Smash" />
              </View>
              <View style={styles.wrap2}>
                <ActionButton onPress={() => play("revers")} text="Revers" />
              </View>
              <View style={styles.wrap3}>
                <ActionButton onPress={() => play("droit")} text="Droit" />
              </View>
            </View>
          </>
        )}
